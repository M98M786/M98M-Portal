...
(function () {
  ...
  function draw() {
    ...
    var cards = [
      ...
      ['dual', 'CPC + cost-per-sale at once', I.dual_funding.count, 'live in both kinds of campaign', I.dual_funding.count > 0],
