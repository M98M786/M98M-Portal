...
function actionListerDraft_(payload, ctx) {
  ...
  /* 16 Sept (owner: "delete that concept, take just item draft link at the submission from the
     item lister"). The keyword/SEO research requirement is REMOVED — a draft link alone hands the
     item to go-live. Nothing downstream reads the research row. */
